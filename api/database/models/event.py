...
from api.database import Base, DictMixIn
...
class Event(Base, DictMixIn):
    ...
    playType = mapped_column(String)
    oddman = mapped_column(String)
    primaryZone = mapped_column(String)
    secondaryZone = mapped_column(String)
    tertiaryZone = mapped_column(String)
    primaryLane = mapped_column(String)
    secondaryLane = mapped_column(String)
    tertiaryLane = mapped_column(String)
    primaryPassType = mapped_column(String)
    secondaryPassType = mapped_column(String)
    tertiaryPassType = mapped_column(String)
